...
import '../screens/payment_screen.dart'; // Adjust path as needed
  ...
  Future<void> _submitBooking() async {
    if (_formKey.currentState!.validate()) {
      final bookingData = {
        ...
        'seats': widget.adults, // Use adults passed to this screen
      };
            ...
            MaterialPageRoute(
              builder:
                  (context) => PaymentScreen(
                    ...
                    seats: widget.adults, // Pass the number of seats
                  ),
            ),
          );
        } else {
